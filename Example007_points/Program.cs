/* Суть задачи! Определить 3 точки. Выбрать 2 любых. Найти середину отрезка между ниими и поставить точку. Выбрать случайную вершину треугольника. Соединить с полученной "серединной" точкой.
...
while (count < 5)                  // Задаем действие программы циклом до 10 (в этот раз) или больше или меньше
{
